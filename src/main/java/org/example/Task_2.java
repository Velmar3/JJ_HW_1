...
public class Task_2 {
    ...
    public void addEmployee() {
        employees.add(new Employee("Иван", 30, 10000, "Руководство"));
        employees.add(new Employee("Ирина", 40, 50000, "Руководство"));
        ...
        employees.add(new Employee("Вася", 50, 8000, "Сан-часть"));
